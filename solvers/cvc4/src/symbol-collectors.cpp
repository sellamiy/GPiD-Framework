#define CVC4_API_INTERFACE_FOR_GPID__SYMBOL_COLLECTORS__CPP
...
void CVC4Declarations::store(CVC4::SymbolTable* table) {
    stable = table;
}

void CVC4Declarations::collect(CVC4::Command* cmd) {
