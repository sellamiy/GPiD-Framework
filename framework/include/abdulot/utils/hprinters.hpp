/**
 * \file abdulot/utils/hprinters.hpp
 * \brief Abdulot Framework Literals printing handlers.
 * \author Yanis Sellami
 * \date 2018
 */
#ifndef ABDULOT__UTILS__HYPOTHESES_PRINTERS_HPP
#define ABDULOT__UTILS__HYPOTHESES_PRINTERS_HPP
