/**
 * \file abdulot/gpid/engine-guniti.hpp
 * \brief Abdulot Framework Guniti Engine for Unit Implicate Generation.
 * \author Yanis Sellami
 * \date 2018
 */
#ifndef ABDULOT__GPID__GUNITI_ENGINE_HPP
#define ABDULOT__GPID__GUNITI_ENGINE_HPP
...
namespace gpid {
    ...
    public:
        ...
        GunitiEngine(size_t size, ContextManagerT& ctx, GPiDOptions& iopts);
        /** Create an abducible engine. */
        template<typename AbducibleSource>
        GunitiEngine(AbducibleSource& source, ContextManagerT& ctx, GPiDOptions& iopts);
