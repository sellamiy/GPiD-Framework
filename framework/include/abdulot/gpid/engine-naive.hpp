/**
 * \file abdulot/gpid/engine-naive.hpp
 * \brief Abdulot Framework Very Naive Abducible Engine for Implicate Generation.
 * \author Yanis Sellami
 * \date 2018
 */
#ifndef ABDULOT__GPID__NAIVE_ENGINE_HPP
...
namespace gpid {
    ...
    public:
        ...
        NaiveAbducibleEngine(size_t size, ContextManagerT& ctx, GPiDOptions& iopts);
        /** Create an abducible engine. */
        template<typename AbducibleSource>
        NaiveAbducibleEngine(AbducibleSource& source, ContextManagerT& ctx, GPiDOptions& iopts);
