...
# ==============================================================================
function(register_solver_library solver_name solver_includes)
...
# ==============================================================================
function(target_solver_static_libraries solver_name)
  set(INTERFACE_STATIC_TARGET gpid-${solver_name}-static)
  target_link_libraries(${INTERFACE_STATIC_TARGET} ${ARGN})
endfunction()
function(target_solver_shared_libraries solver_name)
  set(INTERFACE_SHARED_TARGET gpid-${solver_name}-shared)
  target_link_libraries(${INTERFACE_SHARED_TARGET} ${ARGN})
endfunction()
function(target_solver_libraries solver_name)
  target_solver_static_libraries(${ARGV})
  target_solver_shared_libraries(${ARGV})
endfunction()
# ==============================================================================
function(target_solver_include_directories solver_name)
  set(INTERFACE_STATIC_TARGET gpid-${solver_name}-static)
  set(INTERFACE_SHARED_TARGET gpid-${solver_name}-shared)
  target_include_directories(${INTERFACE_STATIC_TARGET}
    PUBLIC "${ARGN}")
...
# ==============================================================================
function(generate_solver_interface_header solver_name local_include_dir)
...
# ==============================================================================
function(generate_solver_interfaces_global_header)
