...
#script.add_command(core.EvaluationCommand(510, 'problems', 'csp' , 'basic',
#                                          [core.OptionData('timeout', { 1 : 10 })]))
#script.add_command(core.EvaluationCommand(410, 'problems', 'gpid', 'basic',
#                                          [core.OptionData('timeout', { 1 : 10, 2 : 20 })]))

script.add_command(core.EvaluationCommand(405, 'problems', 'gpid', 'basic',
                                          [core.OptionData('timeout', { 1 : 5, 2 : 10 })]))
#script.add_command(core.EvaluationCommand(505, 'problems', 'csp' , 'basic',
#                                          [core.OptionData('timeout', { 1 : 5 })]))

script.add_command(core.EvaluationCommand(403, 'problems', 'gpid', 'basic',
                                          [core.OptionData('timeout', { 1 : 3, 2 : 10 })]))
#script.add_command(core.EvaluationCommand(503, 'problems', 'csp' , 'basic',
#                                          [core.OptionData('timeout', { 1 : 3 })]))
