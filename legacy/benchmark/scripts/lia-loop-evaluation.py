...
script.add_command(core.EvaluationCommand(305, 'qf-uflia', 'gpid', 'basic',
                                          [core.OptionData('timeout', { 1 : 15, 2 : 30 }),
                                           core.OptionData('size-limit', { 1 : 5 })]))
script.add_command(core.EvaluationCommand(310, 'qf-uflia', 'gpid', 'basic',
                                          [core.OptionData('timeout', { 1 : 15, 2 : 30 }),
                                           core.OptionData('size-limit', { 1 : 10 })]))
script.add_command(core.EvaluationCommand(303, 'qf-uflia', 'gpid', 'basic',
                                          [core.OptionData('timeout', { 1 : 15, 2 : 30 }),
                                           core.OptionData('size-limit', { 1 : 3 })]))
