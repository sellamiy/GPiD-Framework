...
namespace starray {
    ...
    public:
         ...
         * @note Complexity: O(1).
         */
        inline uint8_t is_active(uint32_t i) const {
            // assert(i < total_size);
        ...
        /** @warning Untested. */
        inline uint32_t get_maximal_size() const
        { return total_size; }
        /**
         ...
         * @note Complexity: O(1).
         */
        inline uint32_t get_activated_size() const
        ...
        /** @warning Untested. */
        inline uint32_t get_first() const { return tab[list_first.next].index; }
        /** @warning Untested. */
        inline uint32_t get_last() const { return tab[list_last.prev].index; }
        /**
