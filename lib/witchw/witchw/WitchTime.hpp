...
namespace witchw {
    ...
    public:
        ...
        std::string nanoseconds (const std::string& origin, const std::string& target) const;
        /** \brief Compute the duration (in microseconds) between too registered clock times */
        std::string microseconds(const std::string& origin, const std::string& target) const;
        /** \brief Compute the duration (in milliseconds) between too registered clock times */
        std::string milliseconds(const std::string& origin, const std::string& target) const;
        /** \brief Compute the duration (in seconds) between too registered clock times */
        std::string seconds     (const std::string& origin, const std::string& target) const;
        /** \brief Compute the duration (in minutes) between too registered clock times */
        std::string minutes     (const std::string& origin, const std::string& target) const;
        /** \brief Compute the duration (in hours) between too registered clock times */
        std::string hours       (const std::string& origin, const std::string& target) const;
        /** \brief Compute the duration (extended seconds) between two registered clock times */
        std::string extseconds  (const std::string& origin, const std::string& target) const;
        /** \brief Compute the duration (extended) between two registered clock times */
        std::string extended    (const std::string& origin, const std::string& target) const;
        /** \brief Compute the duration (in the selected format) between two registered clock times */
        std::string duration    (const std::string& origin, const std::string& target) const;
    };
